...
st.sidebar.image('https://nycdatascience.com/blog/student-works/olympic-games-data-visualization/')
...
if user_menu == 'Country-wise Analysis':
    ...
    fig, ax = plt.subplots(figsize=(20, 20))
    # create pivot table (this should already exist above)
    st.write(df.columns)  # optional debug (remove later)
    ...
    # 🔥 add safety check HERE (same place)
    if pt.empty:
...
famous_sports = [
    ...
    'Badminton', 'Sailing', 'Gymnastics', 'Art Competition',
    'Handball', 'Weightlifting', 'wrestling', 'water polo',
    'hockey', 'rowing', 'fencing', 'shooting', 'boxing', 'taekondo',
    'cycling', 'diving', 'canoeing', 'volleyball', 'synchronized swimming',
...
for sport in famous_sports:
    ...
    if len(ages) > 1:   # important: need at least 2 values
        x.append(ages.tolist())   # ✅ FIX HERE
        name.append(sport)
